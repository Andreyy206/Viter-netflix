    ...
    <div className='p-4'>
      ...
      <nav>
        <ul className='space-y-5'>
          <li>
            <Link to='/admin/dashboard' className={`${menu === "dashboard" ? "active" : ""} nav-link`}>
              {" "}
              <LayoutDashboard size={16} /> Dashboard{" "}
            </Link>
          </li>
          <li>
            <Link to='/admin/movies' className={`${menu === "movies" ? "active" : ""} nav-link`}>
              {" "}
              <Clapperboard size={16} /> Movies{" "}
            </Link>
          </li>
          <li>
            <Link to='/admin/top-movies' className={`${menu === "top-movies" ? "active" : ""} nav-link`}>
              {" "}
